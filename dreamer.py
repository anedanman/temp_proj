...
class Dreamer:
    ...
    def evaluate(self, env, eval_episodes, render=False):
        ...
        for i in range(eval_episodes):
            ...
            while not done:
                with torch.no_grad():
                    ...
                    img_obs = self.obs_decoder(torch.cat([prior['stoch'], prior['deter']], dim=-1)).mean.cpu().numpy()
                    img_obs = (img_obs[0] + 0.5)*255.0
        ...
        return episode_rew, video_images, imagine_images
    ...
    if args.train:
        ...
        while global_step <= args.total_steps:
            ...
            if global_step % args.test_interval == 0:
                episode_rews, video_images, imagine_images = dreamer.evaluate(test_env, args.test_episodes, render=True)
